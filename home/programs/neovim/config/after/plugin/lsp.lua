...
lsp.on_attach(function(client, bufnr)
   ...
   whichKey.register({
      l = {
         name = 'LSP',
         c = { '<cmd>Telescope lsp_document_symbols ignore_symbol=class,function,method,property,variable<cr>',
            'List Constants',
            { buffer = true } },
         r = { '<cmd>Telescope lsp_references<cr>', 'List References', { buffer = true } },
         m = { '<cmd>Telescope lsp_document_symbols ignore_symbol=constant,class,property,variable<cr>', 'List Methods',
            { buffer = true } },
         p = { '<cmd>Telescope lsp_document_symbols ignore_symbol=constant,class,function,method,variable<cr>',
            'List Properties',
            { buffer = true } },
         s = { '<cmd>Telescope lsp_document_symbols<cr>', 'List Symbols', { buffer = true } },
         v = { '<cmd>Telescope lsp_document_symbols ignore_symbol=constant,class,function,method,property<cr>',
            'List Variables',
            { buffer = true } },
      },
   }, { prfeix = '<leader>' })
