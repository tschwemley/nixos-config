...
# Wayland config
{
  ...
  home.sessionVariables = {
    ...
    # TODO: remove or evaluate the tradeoffs of switching over to this.
    # NOTE: it might be necessary for some applications not using system implemenation of Qt (zoom)
